...
function MenuComodatos() {
    ...
    const handlerClickE =  () => {
        MySwal.fire({
            ...
            MySwal.fire({
                title: 'Ingresa los datos del Vehiculo',
                html: <FormularioMotosEditar onChange={(values) => (formRef.current = values)} tipoVehiculo="Comodatos" data={data}/>,
                showCloseButton: true,
    ...
    <div className="bg-slate-200 grid grid-cols-2 gap-4 lg:flex lg:justify-evenly mt-16 w-full">
