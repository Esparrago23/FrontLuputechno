...
function MenuGasolina() {
    ...
    <div className="bg-slate-200 grid grid-cols-1 sm:grid-cols-2 lg:flex lg:justify-center gap-4 p-4 mt-16 w-full">
        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-auto p-2 mx-auto">
