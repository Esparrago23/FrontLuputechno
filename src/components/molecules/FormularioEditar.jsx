...
//Aqui revisar porque solo con la llamada de este molecula ya lleva la sweetalert 
function FormularioEditar() {
    ...
    const handleEditResguardante = () => {
        // Simulación de llamada a la API
        console.log("Resguardante Editado");
    
        Swal.fire({
            title: '¡Éxito!',
            text: 'Resguardante Ha Sido Editado.',
            icon: 'success',
            confirmButtonText: 'OK',
            target: document.getElementById('principalEditar')
        }).then(() => {
    ...
    return (
        <div  className="flex flex-col m-5 bg-azulIntegradorClaro" id="principalEditar"> 
            <ElementoFormulario
            ...
            <dialog open={isModalOpen} className="border-4 border-black bg-azulIntegradorClaro">
                ...
                <div className="flex justify-center">
                    <button id="botonAgregarResguardante"
                        ...
                        onClick={handleEditResguardante}
                    >
                        Añadir
                    </button>
                </div>
